...
invocation. Do not write generated files into the helper directory or project
unless creating permanent tests was requested.
...
- Prefer headed mode for exploration and screenshots. Use headless for CI or on
  request.
