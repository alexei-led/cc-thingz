---
description:
  Audit and improve AI coding-agent configuration. Use when the user wants to
  review or change Claude Code, Pi, Codex, Gemini, skill, hook, or agent
  configuration. Supports review-only audits and apply-fixes mode. NOT for writing
  new application code, fixing bugs, or any task that isn't about agent/tool
  configuration files.
