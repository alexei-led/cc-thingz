...
description:
  ...
  exact function/type bodies with available structure tools and text-search fallbacks. NOT
  for repo-wide structural pattern search, architecture or trace-flow questions,
